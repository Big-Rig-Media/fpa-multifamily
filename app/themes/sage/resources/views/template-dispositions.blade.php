...
@section('content')
  ...
  <section class="brm-section brm-section--employee">
    <div class="brm-container brm-container--small">
      @include('partials.sections.section-employee', ['employee' => App::employee(157)])
    </div>
  </section>
                        ...
                        <td class="w-1/2 py-2 align-text-top">
                          ...
                          @if( TemplateDispositions::website($disposition) )
                            <span class="block mt-4">
                              <a class="flex flex-row flex-no-wrap items-end text-black" href="{{ TemplateDispositions::website($disposition) }}">
                        ...
                        <td class="w-1/6 py-2 align-text-top">
                          @if( TemplateDispositions::broker($disposition) )
                            ...
                            <span class="block mt-5">
                              <a class="brm-btn brm-btn--primary" href="mailto:{{ TemplateDispositions::email(TemplateDispositions::broker($disposition)) }}">Email</a>
                            </span>
                          @endif
                        </td>
                        <td class="w-1/6 py-2 align-text-top"></td>
