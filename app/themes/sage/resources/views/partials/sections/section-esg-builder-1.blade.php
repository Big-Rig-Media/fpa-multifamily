@if( have_rows('section_1_builder') )
  @while( have_rows('section_1_builder') ) @php the_row() @endphp
    ...
    @endif
  @endwhile
  @if( get_field('section_1_call_to_action_text') && get_field('section_1_call_to_action_url') )
    <div class="my-8 md:my-16 text-center">
      <a class="brm-btn brm-btn--primary" href="{{ get_field('section_1_call_to_action_url') }}">
        {{ get_field('section_1_call_to_action_text') }}
      </a>
    </div>
  @else
    <hr>
