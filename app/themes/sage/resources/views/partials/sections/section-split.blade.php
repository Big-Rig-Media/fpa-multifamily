...
@endphp
<section class="brm-section brm-section--{{ $i }} brm-section--{{ $section_state }} {{ $order_state }} bg-{{ $background_color_state }}">
  <div class="brm-section__bg {{ $background_state }}" data-mobile="{{ $bg_mobile }}" data-desktop="{{ $bg_desktop }}"></div>
  @if( $content )
