@if( have_rows('hero_carousel') )
  <section class="brm-hero brm-hero--carousel has-carousel">
    <div class="brm-hero__carousel js-carousel-hero">
      @while( have_rows('hero_carousel') ) @php the_row() @endphp
        ...
        @endphp
        <div class="brm-hero__carousel__image js-background" data-mobile="{{ $carousel_mobile }}" data-desktop="{{ $carousel_desktop }}"></div>
      @endwhile
    </div>
  </section>
@endif
